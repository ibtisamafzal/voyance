...
export function ResearchOutputSection() {
    ...
    const handleExport = (format: 'csv' | 'html') => {
      ...
      <style>body{font-family:system-ui;padding:2rem;background:#f8fafc;color:#0f172a}
      table{width:100%;border-collapse:collapse}
      th{background:#e2e8f0;padding:12px 16px;text-align:left;font-size:12px;text-transform:uppercase;letter-spacing:.05em;color:#475569}
      td{padding:12px 16px;border-bottom:1px solid rgba(0,0,0,.06);font-size:14px}
      .verified{color:#059669}.unconfirmed{color:#d97706}.low{color:#dc2626}
      h1{color:#0d9488;margin-bottom:.5rem}p{color:#64748b;margin-bottom:2rem}</style></head>
                            ...
                            {state.veraSummary && (
                                <button
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: isVeraPlaying ? 'rgba(124, 58, 237, 0.2)' : 'rgba(13, 148, 136, 0.1)',
                                        boxShadow: isVeraPlaying ? '0 0 16px rgba(124, 58, 237, 0.3)' : undefined,
                                    }}
                                >
                                    {isVeraPlaying ? (
