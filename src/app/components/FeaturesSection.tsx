  ...
  const features: Feature[] = [
    {
      ...
      description: 'Gemini 2.0 Flash reads webpages from screenshots. No DOM access or site-specific APIs required.',
    ...
    },
    {
      ...
      description: 'Perplexity cross-references key pricing claims against the live web before reporting.',
    ...
    },
    {
      ...
      description: 'Firecrawl provides fast structured extraction when available. Gemini vision handles fallback paths.',
    ...
    },
    {
      ...
      description: 'A custom async loop orchestrates Plan → Navigate → Extract → Verify → Report.',
      tag: 'POWERED BY GENAI SDK',
      accentColor: 'var(--accent)',
    ...
    },
    {
      ...
      description: 'Interrupt the session by voice or text. The agent queues your instruction and replans mid-run.',
      tag: 'VOICE + TEXT INTERRUPTS',
      accentColor: 'var(--vera-voice)',
